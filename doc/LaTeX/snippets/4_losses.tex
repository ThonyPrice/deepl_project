\begin{figure*}[htbp]
        ...
        \end{subfigure}
        \caption[]
        {\small Training and validation loss of 20 first epochs of respective models presented in table \ref{table:3_configurations}. Each suffer from immense overfitting after 5-10 epochs of training.}
        \label{fig:4_losses}
    \end{figure*}
