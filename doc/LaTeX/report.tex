...
To combat the overfitting we begun tinkering with what regularization we had in our toolbox, these were:
...
The final results found was achieved with a model of with \textbf{SPECS}. Since it proved a stady learning rate of the 20 first epochs we ran it for 50 in total to see if learning was continued.
